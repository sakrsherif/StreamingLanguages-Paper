...
\mbox{\lstinline{F6=INDEX(B3:B8,F2)}} uses the relative index of the
longest \lstinline{len} to retrieve the corresponding
\lstinline{caller}.  ActiveSheets was influenced by
