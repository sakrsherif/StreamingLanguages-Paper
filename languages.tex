...
- whence: Borealis is evolutionary link from relational \cite{abadi_et_al_2005},
  followed by Spark Streaming~\cite{zaharia_et_al_2013}, Storm~\cite{toshniwal_et_al_2014}, Flink~\cite{carbone_et_al_2015}
\end{alltt}
...
- why: spreadsheet formulas reactive since 1979~\cite{bricklin_frankston_1979},
  ease of use, large user base
- who: Vaziri et al.\ \cite{vaziri_et_al_2014}
- when: 2014
- what: key idea, data model, type system, code example
- where: being developed or offered today, license
- whence: influenced-by SDF \cite{lustre_1987}, FRP \cite{hudak_et_al_2003},
  extended with windows, partitions, opt \cite{hirzel_et_al_2016}
\end{alltt}
