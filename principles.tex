...
language. Only two of the twelve principles (P$_5$ and P$_9$, shown in bold) 
are uniformly covered by all languages. Also, some
of the languages exhibit fewer principles overall or fewer
...
provide a comparative metric for quantifying the coverage of each
principle; such a metric would be difficult to agree upon.
